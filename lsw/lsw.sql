...
INSERT INTO shop_index_product VALUES
    ...
    (NULL,3,'Hello Kitty果汁软糖混合水','Hello Kitty果汁软糖混合水',13.00,'img/index/sm/3f_1.1.jpg','details.html?lid=49'),
    (NULL,3,'Blink冰力克果粉含片糖(青苹果味味)15g','Blink冰力克果粉含片糖(青苹果味味)15g',16.00,'img/index/sm/3f_1.2.jpg','details.html?lid=50'),
    (NULL,3,'顽皮兔可吸冰淇淋奶昔果冻芒果味85g','顽皮兔可吸冰淇淋奶昔果冻芒果味85g',1.50,'img/index/sm/3f_1.3.jpg','details.html?lid=51'),
    (NULL,3,'不二家香醇牛奶硬质奶糖原味 40g','不二家香醇牛奶硬质奶糖原味 40g',9.80,'img/index/sm/3f_1.4.jpg','details.html?lid=52'),
    (NULL,3,'嘉云牌柠檬糖果200g','嘉云牌柠檬糖果200g',14.00,'img/index/sm/3f_1.5.jpg','details.html?lid=53'),
    (NULL,3,'盛香珍可爱狗狗布丁630g','盛香珍可爱狗狗布丁630g',45.00,'img/index/sm/3f_1.6.jpg','details.html?lid=54'),
    (NULL,3,'大眼萌小黄人零钱包糖果15g','大眼萌小黄人零钱包糖果15g',13.50,'img/index/sm/3f_1.7.jpg','details.html?lid=55'),
    (NULL,3,'贝欧宝玫瑰花瓣糖45g','贝欧宝玫瑰花瓣糖45g',4.90,'img/index/sm/3f_1.8.jpg','details.html?lid=56'),
    (NULL,3,'大润谷哆啦A梦什果味哈Q糖（造形胶罐）40g','大润谷哆啦A梦什果味哈Q糖（造形胶罐）40g',10.00,'img/index/sm/3f_2.1.jpg','details.html?lid=57'),
    (NULL,3,'润谷筒装果汁软糖杂果味75g','润谷筒装果汁软糖杂果味75g',5.50,'img/index/sm/3f_2.2.jpg','details.html?lid=58'),
    (NULL,3,'口力汉堡橡皮糖108g','口力汉堡橡皮糖108g',7.50,'img/index/sm/3f_2.3.jpg','details.html?lid=59'),
    (NULL,3,'大润谷哆啦A梦草莓味哈Q糖（坐姿造形胶罐）45g','大润谷哆啦A梦草莓味哈Q糖（坐姿造形胶罐）45g',10.00,'img/index/sm/3f_2.4.jpg','details.html?lid=60'),
    (NULL,3,'Hello Kitty果汁软糖芒果味（直身造型罐）80g','Hello Kitty果汁软糖芒果味（直身造型罐）80g',18.00,'img/index/sm/3f_2.5.jpg','details.html?lid=61'),
    (NULL,3,'Hello Kitty果汁软糖混合水果味（杯装造型）90g','Hello Kitty果汁软糖混合水果味（杯装造型）90g',13.00,'img/index/sm/3f_2.6.jpg','details.html?lid=62'),
    (NULL,3,'大润谷哆啦A梦葡萄味脆皮软糖（坐姿造形胶罐）45g','大润谷哆啦A梦葡萄味脆皮软糖（坐姿造形胶罐）45g',10.00,'img/index/sm/3f_2.7.jpg','details.html?lid=63'),
    (NULL,3,'Hello Kitty果汁软糖心形罐50g','Hello Kitty果汁软糖心形罐50g',12.00,'img/index/sm/3f_2.8.jpg','details.html?lid=64'),
    (NULL,3,'Hello Kitty果汁软糖心形罐50g','Hello Kitty果汁软糖心形罐50g',11.00,'img/index/sm/3f_3.1.jpg','details.html?lid=65'),
    (NULL,3,'盛香珍芒果布丁330g','盛香珍芒果布丁330g',11.00,'img/index/sm/3f_3.2.jpg','details.html?lid=66'),
    (NULL,3,'盛香珍布丁（水蜜桃口味）330g','盛香珍布丁（水蜜桃口味）330g',11.00,'img/index/sm/3f_3.3.jpg','details.html?lid=67'),
    (NULL,3,'盛香珍Triko粉红小熊桶(果汁果冻)580g','盛香珍Triko粉红小熊桶(果汁果冻)580g',48.00,'img/index/sm/3f_3.4.jpg','details.html?lid=68'),
    (NULL,3,'盛香珍Triko小熊果冻桶优酪园(綜合口味)580g','盛香珍Triko小熊果冻桶优酪园(綜合口味)580g',48.00,'img/index/sm/3f_3.5.jpg','details.html?lid=69'),
    (NULL,3,'巧妈妈鸡蛋布甸优酪果冻125g','巧妈妈鸡蛋布甸优酪果冻125g',4.00,'img/index/sm/3f_3.6.jpg','details.html?lid=70'),
    (NULL,3,'巧妈妈奇异果果汁果冻果蜜味125g','巧妈妈奇异果果汁果冻果蜜味125g',4.00,'img/index/sm/3f_3.7.jpg','details.html?lid=71'),
    (NULL,3,'巧妈妈香蕉牛奶布甸果冻165g','巧妈妈香蕉牛奶布甸果冻165g',4.00,'img/index/sm/3f_3.8.jpg','details.html?lid=72'),


    (NULL,4,'零度深林零度杨梅原味*275g 约7个','零度深林零度杨梅原味*275g 约7个',13.80,'img/index/sm/4f_1.1.jpg','details.html?lid=73'),
    (NULL,4,'溜溜梅梅大大黄梅400g','溜溜梅梅大大黄梅400g',30.00,'img/index/sm/4f_1.2.jpg','details.html?lid=74'),
    (NULL,4,'春如四季奇异果干*265g 约6袋','春如四季奇异果干*265g 约6袋',11.50,'img/index/sm/4f_1.3.jpg','details.html?lid=75'),
    (NULL,4,'果然萌秋葵脆58g','果然萌秋葵脆58g',15.50,'img/index/sm/4f_1.4.jpg','details.html?lid=76'),
    (NULL,4,'百年树健康红枣*250g','百年树健康红枣*250g',9.50,'img/index/sm/4f_1.5.jpg','details.html?lid=77'),
    (NULL,4,'百年树桂圆肉*500g 约12小袋','百年树桂圆肉*500g 约12小袋',44.80,'img/index/sm/4f_1.6.jpg','details.html?lid=78'),
    (NULL,4,'百年树香菇脆*280g 约6包','百年树香菇脆*280g 约6包',45.50,'img/index/sm/4f_1.7.jpg','details.html?lid=79'),
    (NULL,4,'百年树榴莲干约45g*1袋','百年树榴莲干约45g*1袋',12.80,'img/index/sm/4f_1.8.jpg','details.html?lid=80'),
    (NULL,4,'雪海梅乡盐津葡萄220g','雪海梅乡盐津葡萄220g',9.90,'img/index/sm/4f_2.1.jpg','details.html?lid=81'),
    (NULL,4,'雪海梅乡珍珠梅230g','雪海梅乡珍珠梅230g',9.90,'img/index/sm/4f_2.2.jpg','details.html?lid=82'),
    (NULL,4,'雪海梅乡黑加仑230g','雪海梅乡黑加仑230g',9.90,'img/index/sm/4f_2.3.jpg','details.html?lid=83'),
    (NULL,4,'雪海梅乡法式樱桃200g','雪海梅乡法式樱桃200g',9.90,'img/index/sm/4f_2.4.jpg','details.html?lid=84'),
    (NULL,4,'雪海梅乡法式樱桃200g','雪海梅乡法式樱桃200g',9.90,'img/index/sm/4f_3.5.jpg','details.html?lid=85'),
    (NULL,4,'雪海梅乡冰花杨梅210g','雪海梅乡冰花杨梅210g',9.90,'img/index/sm/4f_3.6.jpg','details.html?lid=86'),
    (NULL,4,'三味轩日式去核梅蜂蜜味60g','三味轩日式去核梅蜂蜜味60g',5.50,'img/index/sm/4f_3.7.jpg','details.html?lid=87'),


    (NULL,5,'淘豆原味豌豆*100g 约4袋','淘豆原味豌豆*100g 约4袋',3.50,'img/index/sm/5f_1.1.jpg','details.html?lid=88'),
    (NULL,5,'芳草美仁盐焗南瓜子*250g 约11袋','芳草美仁盐焗南瓜子*250g 约11袋',9.80,'img/index/sm/5f_1.2.jpg','details.html?lid=89'),
    (NULL,5,'佳栗福甘栗开口栗180g','佳栗福甘栗开口栗180g',12.00,'img/index/sm/5f_1.3.jpg','details.html?lid=90'),
    (NULL,5,'爱咪咪鱼皮花生*500g 约11小袋','爱咪咪鱼皮花生*500g 约11小袋',12.00,'img/index/sm/5f_1.4.jpg','details.html?lid=91'),
    (NULL,5,'甘源酱汁蚕豆牛肉味*500g 约35小包','甘源酱汁蚕豆牛肉味*500g 约35小包',16.50,'img/index/sm/5f_1.5.jpg','details.html?lid=92'),
    (NULL,5,'芳草香草瓜子218g','芳草香草瓜子218g',14.00,'img/index/sm/5f_1.6.jpg','details.html?lid=93'),
    (NULL,5,'沃隆每日坚果A款 成人款25g','沃隆每日坚果A款 成人款25g',3.80,'img/index/sm/5f_1.7.jpg','details.html?lid=94'),
    (NULL,5,'TOMS蜂蜜黄油扁桃仁35g','TOMS蜂蜜黄油扁桃仁35g',5.00,'img/index/sm/5f_1.8.jpg','details.html?lid=95');
